...
print(desc5_0)
# 6、格式化长度
print("你的信息1：姓名是{:^8},年龄为{:^2},性别是{}".format('ZhangSan', 28, '男'))
print("你的信息2：姓名是{:^8},年龄为{:^2},性别是{}".format('lisi', 36, '男'))
print("你的信息3：姓名是{:^8},年龄为{:^2},性别是{}".format('WangWu', 100, '女'))
print("你的信息4：姓名是{:^8},年龄为{:^2},性别是{}".format('ZhaoWangDeWuSe', 10000, '女'))
# 7、格式化字符长度
# {:^20} ^ 居中对齐
# {:>20} > 向右对齐
# {:<20} < 向左对齐
print("你的信息1：姓名是{:^20},年龄为{:^2},性别是{}".format('ZhangSan', 28, '男'))
print("你的信息2：姓名是{:>20},年龄为{:^2},性别是{}".format('lisi', 36, '男'))
print("你的信息3：姓名是{:<20},年龄为{:^2},性别是{}".format('WangWu', 100, '女'))
